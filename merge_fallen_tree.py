...
SOURCE = r"C:\Users\kk139\Downloads\Fallen Trees On Road.v2i.yolov11"
...
def merge_split(source_split, destination_split):
    ...
    print(
        f"{source_split}: "
        f"{copied} fallen-tree images merged."
    )
...
print()
print("==========================================")
print("Fallen tree dataset merged!")
print("==========================================")