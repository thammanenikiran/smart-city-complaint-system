...
SOURCE = r"C:\Users\kk139\Downloads\Damaged Road Sign Detection.v2-v0.1.yolov11"
...
def merge_split(source_split, destination_split):
    ...
    for image_file in os.listdir(source_images):
        ...
        # Skip images without damaged signs
        ...
        new_name = (
            f"damaged_traffic_sign_{copied:06d}"
        )
    ...
    print(
        f"{source_split}: "
        f"{copied} damaged-traffic-sign images merged."
    )
...
print()
print("==========================================")
print("Damaged traffic sign dataset merged!")
print("==========================================")